...
* in [simple_fitness.m](https://github.com/fstella97/SoftManipulator/blob/main/Optimal%20pose-stiffness/simple_fitness.m) the function to optimize is defined. This is composed of multiple subfunctions (e.g. manifold projection, Forbenius norm etc.), stored in the Utilities folder.
