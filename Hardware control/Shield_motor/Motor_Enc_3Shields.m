...
%4) From the segments length, find the corresponding Encoder readings.
    Enc=[-2000,-2000,-2000,-2000,-2000,-2000,-2000,-2000,-2000];
...
f1=0;f2=0;f3=0;f4=0;f5=0;f6=0;f7=0;f8=0;f9=0;
        while(1)
            enc = getS(s);
            r=[r;enc];
            if (f3==1 && f2 ==1 && f1 ==1 && f4 ==1 && f5 ==1 && f6 ==1 && f7 ==1 && f8 ==1 && f9 ==1)
                f1=0;f2=0;f3=0;f4=0;f5=0;f6=0;f7=0;f8=0;f9=0;
            ...
            % Motor A3
            diff3 = abs(enc(3)-goal_enc(i,3));
            if(diff3>o && f3 ==0)
                if(enc(3) > goal_enc(i,3)+o)
                    m3.Speed = ms1;
                    if(diff3 < 250); m3.Speed = ms2; end
            ...
            % Motor C1
            diff7 = abs(enc(7)-goal_enc(i,7));
            if(diff7>o && f7 ==0)
                if(enc(7) > goal_enc(i,7)+o)
                    m7.Speed = ms1;
                    if(diff7 < 250); m7.Speed = ms2; end
                    if(diff7 < 100); m7.Speed = ms3; end
                end
                if(enc(7) < goal_enc(i,7)-o)
                    m7.Speed = -ms1;
                    if(diff7 < 250); m7.Speed = -ms2; end
            ...
            % Motor C2
            diff8 = abs(enc(8)-goal_enc(i,8));
            if(diff8>o && f8 ==0)
                if(enc(8) > goal_enc(i,8)+o)
                    m8.Speed = ms1;
                    if(diff8 < 250); m8.Speed = ms2; end
                    if(diff8 < 100); m8.Speed = ms3; end
                end
                if(enc(8) < goal_enc(i,8)-o)
                    m8.Speed = -ms1;
                    if(diff8 < 250); m8.Speed = -ms2; end
            ...
            % Motor C3
            diff9 = abs(enc(9)-goal_enc(i,9));
            if(diff9>o && f9 ==0)
                if(enc(9)> goal_enc(i,9)+o)
                    m9.Speed = ms1;
                    if(diff9 < 250); m9.Speed = ms2; end
                    if(diff9 < 100); m9.Speed = ms3; end
                end
                if(enc(9) < goal_enc(i,9)-o)
                    m9.Speed = -ms1;
                    if(diff9 < 250); m9.Speed = -ms2; end
            ...
            disp([diff1 diff2 diff3 diff4 diff5 diff6 diff7 diff8 diff9]')
        end
