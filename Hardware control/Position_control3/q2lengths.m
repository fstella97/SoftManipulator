...
%                       xlim([0,1])
%                       ylim([0,1])
q1a=pi ;q1c=0.001;q1l=210;
q2a=pi;q2c=pi/2.2;q2l=210;
q3a=pi;q3c=pi/2.2 ;q3l=210;
...
K_desired=[50,0,0;0,50,0;0,0,150]
my_ellips([body3(20,1),body3(20,2),body3(20,3)]',K_desired,1,'g')
%% wires plotting
plot3([rack1(1,1),rack1(20,1)],[rack1(1,2),rack1(20,2)],[rack1(1,3),rack1(20,3)]','k','linewidth',0.5)
plot3([rack2(1,1),rack2(20,1)],[rack2(1,2),rack2(20,2)],[rack2(1,3),rack2(20,3)]','k','linewidth',0.5)
plot3([rack3(1,1),rack3(20,1)],[rack3(1,2),rack3(20,2)],[rack3(1,3),rack3(20,3)]','k','linewidth',0.5)
...
Enc=(L-q1l)./0.004;%0.00275;%0.0055
%%
